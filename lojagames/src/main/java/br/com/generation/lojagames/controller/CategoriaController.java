...
public class CategoriaController {
	...
	public ResponseEntity<List<CategoriaModel>> GetByTipo(@PathVariable CategoriaModel categoria) {
		return ResponseEntity.ok(categoriaRepository.findAllByTipoContainingIgnoreCase(categoria));
	}

	@PostMapping
	public ResponseEntity<CategoriaModel> postPostagem(@RequestBody CategoriaModel categoria) {
		return ResponseEntity.status(HttpStatus.CREATED).body(categoriaRepository.save(categoria));
	}

	@PutMapping
	public ResponseEntity<CategoriaModel> putPostagem(@RequestBody CategoriaModel categoria) {
